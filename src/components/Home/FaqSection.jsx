                    ...
                    <div className="col-12 col-md-6">
                      <div itemProp="mainEntity" itemScope="" itemType="https://schema.org/Question">
                        ...
                        <div aria-labelledby="heading-0" className="collapse" data-parent="#faq-accordion-set-1" id="collapse-3" itemProp="acceptedAnswer" itemScope="" itemType="https://schema.org/Answer">
                          <div className="wealth-faq-collapse-content" itemProp="text">
                            Absolutely. Just use ‘Add a Family Member’ in your brand name account. This new account will be linked to your existing brand name account, and you’ll get a single dashboard that helps you make better decisions,
                      ...
                      <div itemProp="mainEntity" itemScope="" itemType="https://schema.org/Question">
                        ...
                        <div aria-labelledby="heading-2" className="collapse" data-parent="#faq-accordion-set-1" id="collapse-5" itemProp="acceptedAnswer" itemScope="" itemType="https://schema.org/Answer">
                          <div className="wealth-faq-collapse-content" itemProp="text">
                            We have invested in technology that ensures the system’s security. Our money is invested here too, remember? Your money moves directly from your bank to the mutual fund account, and a record of your investments
                            is stored electronically by the mutual fund company, which will send you regular statements too.
                          </div>
                        </div>
                      </div>
                    </div>
